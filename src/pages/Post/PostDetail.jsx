...
// Simplified Comments Component - Always Expanded
const Comments = ({ reflections, onAvatarClick }) => {
        ...
        {reflections.map((reflection) => (
          <div key={reflection.id} className="flex gap-3">
            <img
              ...
              className="w-8 h-8 cursor-pointer rounded-2xl object-cover flex-shrink-0 hover:scale-105 transition-transform duration-200"
          ...
          <div className="space-y-10">
            {posts.map((post, index) => (
              <div key={post.id} className="relative">
                {/* Border */}
                {index > 0 && (
                  <div className="border-t border-gray-100 pt-10 -mt-4"></div>
                )}
